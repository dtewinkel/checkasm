...
[Files]
Source: "..\bin\Release-Licensed\CheckAsm.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\bin\Release-Licensed\CCheckAsm.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\bin\Release-Licensed\CheckAsm.pdb"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\bin\Release-Licensed\CCheckAsm.pdb"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\bin\Release-Licensed\CheckAsm.exe.config"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\bin\Release-Licensed\CheckAsm.XmlSerializers.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\bin\Release-Licensed\Amberfish.Canvas.dll"; DestDir: "{app}"; Flags: ignoreversion
