...
[Files]
Source: "..\bin\Release\CheckAsm.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\bin\Release\CheckAsm.pdb"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\bin\Release\CheckAsm.exe.config"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\bin\Release\CheckAsm.XmlSerializers.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\common\win32support.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\bin\Release\Amberfish.Canvas.dll"; DestDir: "{app}"; Flags: ignoreversion
